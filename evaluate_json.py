...
def get_val_info(args):
    ...
    AP_matrix = torch.zeros((args.max_channel, len(THRESHOLDS))).cuda()#3 3
    ...
    for pred_map, confidence_level, gt_map in tqdm.tqdm(data_loader):
        ...
        CD1, CD2, num1, num2 = semantic_mask_chamfer_dist_cum(pred_map, gt_map, args.xbound[2], args.ybound[2], threshold=args.CD_threshold)#5
