...
class HDMapNet(nn.Module):
    def __init__(self, data_conf, instance_seg=True, embedded_dim=16, direction_pred=True, direction_dim=36, lidar=False):
        ...
        self.camencode = CamEncode(self.camC)#初始化对象
        fv_size = (data_conf['image_size'][0]//self.downsample, data_conf['image_size'][1]//self.downsample)#下采样后图片大小
        bv_size = (final_H//5, final_W//5)#鸟瞰图大小？
        self.view_fusion = ViewTransformation(fv_size=fv_size, bv_size=bv_size)#初始化变换对象
